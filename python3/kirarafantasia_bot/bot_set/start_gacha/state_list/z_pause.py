...
def on_event(bot_logic, event):
    ...
    if event.type == pygame.MOUSEBUTTONUP:
        ...
        if (pos[0] >= 0) and (pos[0] < VIDEO_SIZE[0]) and (pos[1] >= 0) and (pos[1] < VIDEO_SIZE[1]):
            ...
            vv['move_queue'].append((1136*1/2,640*6/8,0))
            vv['move_queue'].append((1136*1/2,640*6/8,1))
            vv['move_queue'].append((1136*1/2,640*0/8,1))
            vv['move_queue'].append((1136*1/2,640*0/8,0))
        elif clover.common.in_rect(pos,DRAG_SOUTH_BTN_RECT):
            vv['move_queue'].append((1136*1/2,640*2/8,0))
            vv['move_queue'].append((1136*1/2,640*2/8,1))
            vv['move_queue'].append((1136*1/2,640*8/8,1))
            vv['move_queue'].append((1136*1/2,640*8/8,0))
            ...
            vv['move_queue'].append((1136*8/8,640*4/8,1))
            vv['move_queue'].append((1136*8/8,640*4/8,0))
            ...
            vv['move_queue'].append((1136*0/8,640*4/8,1))
            vv['move_queue'].append((1136*0/8,640*4/8,0))
